...
from bowling import CalculatePlayerResults
import argparse
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Input file for calculate results, output file for write results')
    parser.add_argument('-in', '--input', type=str, help='Input file with games results')
    parser.add_argument('-out', '--output', type=str, help='Output file for write results')
    args = parser.parse_args()
    # results = CalculatePlayerResults(args.input, args.output)
    results = CalculatePlayerResults(input_file, output_file)
    results.run()
